...
Route::middleware(['auth', \App\Http\Middleware\TrackUserActivity::class])->group(function () {
...
// User routes
Route::middleware(['auth', 'user', \App\Http\Middleware\TrackUserActivity::class])->group(function () {
...
Route::middleware(['auth', 'resource-officer', \App\Http\Middleware\TrackUserActivity::class])->group(function () {
    ...
    Route::get('resource-officer/import-electrical', [App\Http\Controllers\ResourceOfficerController::class, 'importElectricalForm'])->name('resource-officer.import-electrical');
    Route::post('resource-officer/import-electrical', [App\Http\Controllers\ResourceOfficerController::class, 'importElectrical'])->name('resource-officer.import-electrical.upload');
    ...
    Route::get('resource-officer/item/{itemType}/{item}/edit', [App\Http\Controllers\ResourceOfficerController::class, 'edit'])->name('resource-officer.item.edit');
    Route::put('resource-officer/item/{itemType}/{item}', [App\Http\Controllers\ResourceOfficerController::class, 'update'])->name('resource-officer.item.update');
    Route::delete('resource-officer/item/{itemType}/{item}', [App\Http\Controllers\ResourceOfficerController::class, 'destroy'])->name('resource-officer.item.destroy');
...
// Store Watcher routes
Route::middleware(['auth', 'store-watcher', \App\Http\Middleware\TrackUserActivity::class])->group(function () {
    Route::get('store-watcher', [App\Http\Controllers\StoreWatcherController::class, 'index'])->name('store-watcher');
    Route::get('store-watcher/borrow-history/export', [App\Http\Controllers\StoreWatcherController::class, 'exportBorrowHistory'])->name('store-watcher.borrow-history.export');
    Route::post('store-watcher/borrow-request/{borrowRequest}/release', [App\Http\Controllers\StoreWatcherController::class, 'releaseBorrowRequest'])->name('store-watcher.borrow-request.release');
    Route::post('store-watcher/return/{borrowHistory}/approve', [App\Http\Controllers\StoreWatcherController::class, 'approveReturn'])->name('store-watcher.return.approve');
    Route::post('store-watcher/return/{borrowHistory}/reject', [App\Http\Controllers\StoreWatcherController::class, 'rejectReturn'])->name('store-watcher.return.reject');
});
...
Route::middleware(['auth', 'superadmin', \App\Http\Middleware\TrackUserActivity::class])->group(function () {
