<x-layout>
    <div class="py-10 px-3 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
            <div class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-blue-50 text-blue-700 mb-6">
                <span class="text-3xl font-bold">404</span>
            </div>
            <h1 class="text-3xl font-bold text-slate-900 mb-3">Page not found</h1>
            <p class="text-slate-600 mb-6">The page you are looking for does not exist or may have been moved.</p>
